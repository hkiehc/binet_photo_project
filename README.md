...
-pour télécharger le répertoire la première fois:  
se placer dans un répertoire choisie via le terminale puis executer : git clone https://github.com/hkiehc/binet_photo_project.git
